...
class HomeViewController: UIViewController {
    ...
    @IBAction func medicineUserButtonTapped(_ sender: Any) {
        createAlertForMedicineUser(title: "Medicine User Chosen", message:  "The identy won't be able to change after this confirmation.")
    }
    @IBAction func careTakerButtonTapped(_ sender: Any) {
        createAlertForCareTaker(title: "Care Taker Chosen", message: "The identy won't be able to change after this confirmation.")
